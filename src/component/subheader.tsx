...
import { BotIcon, Box, BoxIcon, Brain, Globe, Globe2, Lock, Search, Settings, Sparkles } from "lucide-react";
  ...
  return (
    <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
      <GridItem
        ...
        description="Every comment, vote, journal entry, and interaction enriches your AI-generated psychometric profile. You control how it's used and who can access it."
      />
      ...
      <GridItem
        ...
        icon={<BoxIcon className="h-4 w-4 text-black dark:text-neutral-400" />}
      ...
      <GridItem
        ...
        icon={<BotIcon className="h-4 w-4 text-black dark:text-neutral-400" />}
