...
export default function OpenPoliticaLanding() {
  ...
  const [badgeMousePosition, setBadgeMousePosition] = useState({ x: 0, y: 0 });
  const [isBadgeHovered, setIsBadgeHovered] = useState(false);
  const [navMousePositions, setNavMousePositions] = useState({
    dashboard: { x: 0, y: 0 },
    aijournal: { x: 0, y: 0 },
    profile: { x: 0, y: 0 },
    project: { x: 0, y: 0 }
  ...
  const handleNavMouseMove = (navItem, e) => {
    const rect = e.currentTarget.getBoundingClientRect();
    setNavMousePositions(prev => ({
      ...prev,
      [navItem]: {
        x: e.clientX - rect.left,
        y: e.clientY - rect.top
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center space-x-8">
            <div className="text-2xl font-bold">
              ...
              <span className="text-shadow-white">Politica</span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <button 
              ...
              className={`relative text-gray-400 hover:text-white transition-all duration-150 font-medium px-4 py-2 rounded-lg hover:bg-white/10 hover:backdrop-blur-sm hover:scale-105 group ${clickedItem === 'Log in' ? 'scale-90 bg-white/30' : ''}`}
            >
              Log in
            ...
            <button 
              ...
              className={`relative px-6 py-2 bg-white text-black rounded-lg hover:bg-gray-100 transition-all duration-150 font-medium hover:scale-105 hover:shadow-lg hover:shadow-white/20 group overflow-hidden ${clickedItem === 'Sign up' ? 'scale-90 bg-gray-300' : ''}`}
            >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-6 pt-16">
        <div className="text-center space-y-8 max-w-6xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
          ...
          <p className="text-xl md:text-2xl text-gray-400 leading-relaxed max-w-4xl mx-auto">
            OpenPolitica is the world's first social media platform where you own your data,<br />
            and your digital identity becomes a valuable asset.
          </p>

          {/* Status indicators badge - moved below subheading */}
          <div className="inline-flex items-center space-x-6 px-6 py-3 bg-gray-900/20 border border-gray-700/50 rounded-full backdrop-blur-sm">
            <span className="text-white font-medium">100% Human</span>
            <div className="w-1 h-1 bg-gray-500 rounded-full"></div>
            <span className="text-white font-medium">0% Bots</span>
            <div className="w-1 h-1 bg-gray-500 rounded-full"></div>
            <span className="text-white font-medium">100% Yours</span>
          </div>

          {/* CTA Button with Border Magic effect and movable glow */}
          <div className="pt-6">
            <div 
            ...
            >
              ...
              {isCtaHovered && (
                <div
                  ...
                  style={{
                    left: ctaMousePosition.x - 40,
                    top: ctaMousePosition.y - 40,
                    width: '80px',
                    height: '80px',
              ...
              >
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-6 py-1 text-sm font-medium text-white backdrop-blur-3xl group">
          ...
          {/* Features Section */}
          <div className="pt-20">
            <div className="relative border-2 border-gray-600 rounded-lg p-12 max-w-6xl mx-auto bg-black overflow-hidden"
                 style={{
                   boxShadow: '0 0 20px rgba(249, 115, 22, 0.3), 0 0 40px rgba(249, 115, 22, 0.15), 0 0 60px rgba(249, 115, 22, 0.1)'
                 }}>
              {/* Moving glowing line */}
              <div 
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-300 leading-relaxed">
                    ...
                    <span className="font-bold text-white">only accessible by you</span>. 
                ...
                <div className="flex justify-center items-center">
                  <div className="w-80 h-60 border border-gray-600 rounded-lg bg-gray-800 flex items-center justify-center">
